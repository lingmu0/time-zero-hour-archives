...
public final class TimeRuinStructure extends Structure {
    public static final Codec<TimeRuinStructure> CODEC = RecordCodecBuilder.create(instance ->
    ...
    @Override protected Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        int surface = context.chunkGenerator().getFirstOccupiedHeight(x + 12, z - 7, Heightmap.Types.WORLD_SURFACE_WG, context.heightAccessor(), context.randomState());
        ...
        return Optional.of(new GenerationStub(new BlockPos(x + 12, surface, z - 7), builder -> builder.addPiece(new TimeRuinPiece(origin, variant, surface))));
    }
