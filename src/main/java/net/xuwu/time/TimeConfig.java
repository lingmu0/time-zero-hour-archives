...
public final class TimeConfig {
    ...
    public static final ForgeConfigSpec.DoubleValue BOSS_SECOND_HEALTH;
    public static final ForgeConfigSpec.DoubleValue BOSS_DAMAGE;
    public static final ForgeConfigSpec.IntValue SECOND_PHASE_BOLT_COUNT;
    public static final ForgeConfigSpec.IntValue SECOND_PHASE_BOLT_INTERVAL;
    public static final ForgeConfigSpec.DoubleValue SECOND_PHASE_TIDE_SPEED;
